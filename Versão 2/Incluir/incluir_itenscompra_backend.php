...
$inserir = mysql_query("INSERT INTO tb_itenscompra 
          (itenscompra_codigo,com_codigo,pro_codigo,tpp_codigo,nf_codigo,for_codigo,tpg_codigo,itc_embalagem,itc_qtde,itc_valorun,itc_desc,itc_valortotal)
           VALUES('$itenscompra_codigo1','$com_codigo1','$pro_codigo1',
          		  '$tpp_codigo1','$nf_codigo1','$for_codigo1',
          		  '$tpg_codigo1','$itc_embalagem1','$itc_qtde1',
           		  '$itc_valorun1','$itc_desc1','$itc_valortotal1')") 
		   or die (mysql_error());
mysql_close ($db);
